...
gym.register(
    id="Template-Rob6323-Go2-Biped-Direct-v0",
    entry_point=f"{__name__}.biped_rob6323_go2_env:BipedRob6323Go2Env",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.biped_rob6323_go2_env_cfg:BipedRob6323Go2EnvCfg",
